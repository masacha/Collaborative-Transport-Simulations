...
/*Mobile Robot Outputs*/
	...
	double err_v_left1 = 0.0;
	double err_int_v_left1 = 0.0;
	double err_der_v_left1 = 0.0;
	double pre_err_v_left1 = 0.0;
	double err_w_left1 = 0.0;
	double err_int_w_left1 = 0.0;
	double err_der_w_left1 = 0.0;
	double pre_err_w_left1 = 0.0;
...
/*Mobile Robot Outputs*/
	...
	double err_v_left2 = 0.0;
	double err_int_v_left2 = 0.0;
	double err_der_v_left2 = 0.0;
	double pre_err_v_left2 = 0.0;
	double err_w_left2 = 0.0;
	double err_int_w_left2 = 0.0;
	double err_der_w_left2 = 0.0;
	double pre_err_w_left2 = 0.0;
...
/*Mobile Robot Outputs*/
	...
	double err_v_right1 = 0.0;
	double err_int_v_right1 = 0.0;
	double err_der_v_right1 = 0.0;
	double pre_err_v_right1 = 0.0;
	double err_w_right1 = 0.0;
	double err_int_w_right1 = 0.0;
	double err_der_w_right1 = 0.0;
	double pre_err_w_right1 = 0.0;
...
/*OBJECT*/
	...
	while(t <= T){	
		...
		err_v_left1 = v_t - R_w*(dtheta_res_left1_l+dtheta_res_left1_r)/2;
		err_w_left1 = w_t - R_w*(dtheta_res_left1_r-dtheta_res_left1_l)/(2*R_r);
		err_int_v_left1 = err_int_v_left1 + err_v_left1*ST;
 		err_int_w_left1 = err_int_w_left1 + err_w_left1*ST;
		err_der_v_left1 = (err_v_left1 - pre_err_v_left1)/ST;
		err_der_w_left1 = (err_w_left1 - pre_err_w_left1)/ST;
		pre_err_v_left1 = err_v_left1;
		pre_err_w_left1 = err_w_left1;

		dv_ref_left1 = K_pl*(err_v_left1)+K_il*(err_int_v_left1)+K_dl*(err_der_v_left1);
		dw_ref_left1 = K_pa*(err_w_left1)+K_ia*(err_int_w_left1)+K_da*(err_der_w_left1);
		...
		err_v_left2 = v_t - R_w*(dtheta_res_left2_l+dtheta_res_left2_r)/2;
		err_w_left2 = w_t - R_w*(dtheta_res_left2_r-dtheta_res_left2_l)/(2*R_r);
		err_int_v_left2 = err_int_v_left2 + err_v_left2*ST;
 		err_int_w_left2 = err_int_w_left2 + err_w_left2*ST;
		err_der_v_left2 = (err_v_left2 - pre_err_v_left2)/ST;
		err_der_w_left2 = (err_w_left2 - pre_err_w_left2)/ST;
		pre_err_v_left2 = err_v_left2;
		pre_err_w_left2 = err_w_left2;

		dv_ref_left2 = K_pl*(err_v_left2)+K_il*(err_int_v_left2)+K_dl*(err_der_v_left2);
		dw_ref_left2 = K_pa*(err_w_left2)+K_ia*(err_int_w_left2)+K_da*(err_der_w_left2);
		...
		err_v_right1 = v_t - R_w*(dtheta_res_right1_l+dtheta_res_right1_r)/2;
		err_w_right1 = w_t - R_w*(dtheta_res_right1_r-dtheta_res_right1_l)/(2*R_r);
		err_int_v_right1 = err_int_v_right1 + err_v_right1*ST;
 		err_int_w_right1 = err_int_w_right1 + err_w_right1*ST;
		err_der_v_right1 = (err_v_right1 - pre_err_v_right1)/ST;
		err_der_w_right1 = (err_w_right1 - pre_err_w_right1)/ST;
		pre_err_v_right1 = err_v_right1;
		pre_err_w_right1 = err_w_right1;

		dv_ref_right1 = K_pl*(err_v_right1)+K_il*(err_int_v_right1)+K_dl*(err_der_v_right1);
		dw_ref_right1 = K_pa*(err_w_right1)+K_ia*(err_int_w_right1)+K_da*(err_der_w_right1);
