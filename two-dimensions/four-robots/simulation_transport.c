...
/*Mobile Robot Inputs*/
	...
	double dv_ref_right2 = 0.0;
	double dw_ref_right2 = 0.0;
...
/*OBJECT*/
	...
	while(t <= T){	
		...
		f_right2_command = -3.0;
		
		x_c_right2 = x_res_right2 + cos(phi_o+Pi)*(R_r)-sin(phi_o+Pi)*(0.0);
		y_c_right2 = y_res_right2+ sin(phi_o+Pi)*(R_r)+cos(phi_o+Pi)*(0.0);
		...
		dv_ref_right2 = K_f*(f_right2_command-f_dis_right2);
		dw_ref_right2 = 0.0;

		/*right2 Motor Controller*/

		ddtheta_ref_right2_l = dv_ref_right2/R_w - R_r*dw_ref_right2/R_w;
		ddtheta_ref_right2_r = dv_ref_right2/R_w + R_r*dw_ref_right2/R_w;
		...
		ddx_o = (f_dis_left1*cos(phi_res_left1)+f_dis_left2*cos(phi_res_left2)+f_dis_right1*cos(phi_res_right1)+f_dis_right2*cos(phi_res_right2))/M_o - D_f*dx_o;
		dx_o += ddx_o*ST;
		x_o += dx_o*ST;
		ddy_o = (f_dis_left1*sin(phi_res_left1)+f_dis_left2*sin(phi_res_left2)+f_dis_right1*sin(phi_res_right1)+f_dis_right2*sin(phi_res_right2))/M_o - D_f*dy_o;
		dy_o += ddy_o*ST;
		y_o += dy_o*ST;
		...
		fprintf(fp, "%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n", t, x_o, y_o, phi_o, x_res_left1, y_res_left1, phi_res_left1, f_dis_left1, x_res_right1, y_res_right1, phi_res_right1, f_dis_right1, x_res_left2, y_res_left2, phi_res_left2, f_dis_left2, x_res_right2, y_res_right2, phi_res_right2, f_dis_right2);
