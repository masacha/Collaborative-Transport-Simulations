...
data = np.genfromtxt('simulation_grasping.dat',
                     names=True,
                     dtype=None,
                     delimiter=' ')
...
def init():
    ...
    return left1, left1front, left2, left2front, right1, right1front, right2, right2front, rectangle,
...
def animate(i):
    ...
    right2.center = (data[frame_skip*i][16], data[frame_skip*i][17])
    right2front.center = (data[frame_skip*i][16]+np.cos(data[frame_skip*i][18])*0.1, data[frame_skip*i][17]+np.sin(data[frame_skip*i][18])*0.1)
    return left1, left1front, left2, left2front, right1, right1front, right2, right2front, rectangle,
