...
wall = plt.Polygon([[2.5, -0.25],[2.5,2]],fc='black')
...
def animate(i):
    ...
    left3.center = (data[frame_skip*i][16], data[frame_skip*i][17])
    left3front.center = (data[frame_skip*i][16]+np.cos(data[frame_skip*i][18])*0.08, data[frame_skip*i][17]+np.sin(data[frame_skip*i][18])*0.08)
    return left1, left1front, left2, left2front, left3, left3front, rectangle, wall,
